...
import { DevicePhoneMobileIcon, GlobeAmericasIcon, CheckCircleIcon, IdentificationIcon, VideoCameraIcon, ArrowPathIcon } from '../constants';
                        ...
                        <div className="space-y-6">
                            ...
                            {currentStep === 4 && (
                                <div className="space-y-4 animate-fade-in">
                                    ...
                                    <button onClick={handleSubmit} className="w-full py-4 bg-green-600 text-white font-bold rounded-lg shadow-lg hover:bg-green-700 transition-transform hover:scale-[1.02]">
                                        Submit Application
                                    </button>
                                    <button onClick={() => setCurrentStep(3)} className="w-full py-3 text-gray-500 text-sm underline">Edit Details</button>
                                </div>
                            )}

                            {/* Step 5: Success */}
                            {currentStep === 5 && submissionId && (
                                <div className="text-center py-10 animate-scale-in">
                                    ...
                                    <div className="bg-gray-100 p-4 rounded-lg inline-block mb-6">
                                        ...
                                        <p className="text-xl font-mono font-bold text-brand-primary">{submissionId}</p>
                                    </div>
                                    <p className="text-sm text-gray-500">You will receive an email update shortly.</p>
                                    <button onClick={() => { setCurrentStep(1); setSubmissionId(null); }} className="mt-8 text-brand-secondary font-bold">Start New Application</button>
                                </div>
                            )}
                        </div>
                    )}
                        ...
                        <div className="space-y-6">
                            ...
                            {checkStatusResult && (
                                <div className="mt-6 p-6 bg-gray-50 rounded-lg border text-center animate-fade-in">
                                    ...
                                    <span className={`px-4 py-2 rounded-full text-lg font-bold ${checkStatusResult.status === 'APPROVED' ? 'bg-green-100 text-green-800' : 'bg-amber-100 text-amber-800'}`}>
